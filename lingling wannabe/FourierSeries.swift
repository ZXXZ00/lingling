...
public class FourierSeries {
    ...
    public init(real: [Float], imag: [Float], position: CGPoint = .zero, duration: Double = 10, origin: CGPoint = .zero) {
    ...
    public convenience init(points: [CGPoint], position: CGPoint = .zero, origin: CGPoint = .zero) {
        var tmpR: [Float] = []
        var tmpI: [Float] = []
        for point in points {
        ...
        self.init(real: tmpR, imag: tmpI, position: position, origin: origin)
    }
